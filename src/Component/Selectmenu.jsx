const Selectmenu = ({ region, onSelectRegion, theme }) => {
  ...
  return (
    <div className="mt-10 ml-5   mb-10 lg:-mr-5 xl:-mr-4 2xl:-mr-9 ">
      <div
        className={`flex px-5 py-3 w-[12rem] cursor-pointer shadow-md rounded-lg ${
          theme === "dark"
      ...
      >
        <select
          className={` pl-2 text-gray-600 text-base rounded-lg block w-full  focus:outline-none cursor-pointer ${
